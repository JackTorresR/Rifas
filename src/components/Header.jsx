    ...
    <header className="cabecalho">
      <div className="container cabecalho__conteudo">
        ...
        <div className="cabecalho__premio">
          {config.fotoPremio ? (
            <img className="cabecalho__premio-foto" src={config.fotoPremio} alt="Foto do prêmio" />
          ) : (
            <div className="cabecalho__premio-placeholder">Foto do prêmio</div>
          )}

          <div className="medalhao-preco">
            <span className="medalhao-preco__valor">{formatarMoeda(config.valorNumero)}</span>
